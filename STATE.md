...
- **No test WABA exists**, so nothing verifies an agent's real WhatsApp behaviour end to end.
...
- **Agent `887643060282855424`** (Astrotalk, +91 96422 01123) is live and real. It has never held a real conversation. Treat it as production.
