...
docs/knowledge-index/_archive-long-form.json — Frozen archive of the pre-2026-09-21 JSON index. Not maintained and not read; the long-form purposes are kept only for lookback.
